...
export class MicrophoneOffIcon extends AbstractIcon {
  static selector = "microphone-off-icon";

  getHTML() {
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
      <path d="M9.18,18.57A7.41,7.41,0,0,1,9,17V14H7v3a8.84,8.84,0,0,0,.58,3.18Z"/>
...
componentsRegistryService.define(MicrophoneOffIcon);
